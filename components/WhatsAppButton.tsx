...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-24 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-crema-light shadow-lg transition hover:scale-105 sm:bottom-5"
    >
